 ...
 *
 * ここには 'use client' を付けない。ランキング 102 ページと業種 33 ページは
 * サーバーコンポーネントなので、そのまま静的 HTML になりハイドレーションが
 * 一切走らない（最大のランキングは 596 社 × 2 = 1,192 行ある）。
 * 行のどこを押しても開く挙動が要る一覧では CompanyTable が包む。
 */
interface Props {
...
export default function CompanyRows({
  entries,
  statsByIndustry,
  activeCode = null,
  keepScroll = false,
