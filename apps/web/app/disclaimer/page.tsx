...
export default function DisclaimerPage() {
  return (
    <main className={styles.main}>
      ...
      <section className={styles.panel}>
        ...
        <div className={styles.body}>
          ...
          <p>
            ...
            また、特定の企業への投資を勧めるもの、就職や転職を勧めたり避けるよう促したりするものでもありません。なお、掲載している数値とは別に、広告を掲載しているページがあります（後述）。
      ...
      <section className={styles.panel}>
        <h2 className={styles.h2}>広告掲載について</h2>
        <div className={styles.body}>
          <p>
            当サイトは、運営費用にあてるためアフィリエイトプログラムによる広告を掲載しています。
            広告であることが分かるよう、該当箇所には「広告」と表示しています。
          </p>
          <p>
            広告からの収益は、<strong>掲載する企業の選定、抽出する数値、並び順には一切影響しません</strong>。
            広告主となっている事業者が有利になるような編集は行っていません。
            掲載している企業と広告主との間に関係はなく、
            広告の表示は当該企業の推薦や、当該企業からの承認を意味するものでもありません。
          </p>
          <p>
            広告のリンク先は当サイトの管理外です。リンク先での取引、提供される
            サービスの内容、その結果について、運営者は責任を負いません。
            リンク先の利用条件やプライバシーポリシーは、各サイトでご確認ください。
          </p>
          <p>
            広告配信にともなう Cookie の取り扱いは{' '}
            <Link href="/privacy/">プライバシーポリシー</Link> に記載しています。
          </p>
        </div>
      </section>
