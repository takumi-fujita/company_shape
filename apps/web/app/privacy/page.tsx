  ...
  return (
    <main className={styles.main}>
      ...
      <section className={styles.panel}>
        ...
        <div className={styles.body}>
          <p>
            ...
            掲載している広告の成果計測や、今後導入するアクセス解析では、それらの事業者が Cookie を利用します。
          </p>
          <p>
      ...
      <section className={styles.panel}>
        ...
        <div className={styles.body}>
          <p>
            当サイトでは、アフィリエイトプログラムによる広告を掲載しています。広告主および広告配信事業者は、広告の成果を計測するために Cookie を使用し、当サイトや他サイトへのアクセス情報を参照することがあります。氏名・住所・メールアドレス・電話番号は含まれません。
          </p>
          <p>
            パーソナライズ広告は{' '}
          ...
          <p>
            今後、第三者配信の広告サービス（Google AdSense を含む）を利用する場合も、本ページに追記します。
          </p>
        </div>
      </section>
