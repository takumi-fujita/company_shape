    ...
    <main className={styles.main}>
      ...
      <section className={styles.panel}>
        ...
        <div className={styles.body}>
          ...
          <p>
            掲載している企業から、掲載の依頼・対価・出資を受けたことはありません。
            掲載順や掲載内容が対価によって変わることもありません。
          </p>
          <p>
            運営費用にあてるため、一部のページにアフィリエイトプログラムによる広告を掲載しています。
            広告からの収益は、掲載する企業の選定・数値・並び順には影響しません。
            詳しくは <Link href="/disclaimer/">免責事項</Link> をご覧ください。
          </p>
        </div>
      </section>
